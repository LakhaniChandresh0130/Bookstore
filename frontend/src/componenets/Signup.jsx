...
function Signup() {
  ...
  return (
    ...
    <div className="modal-box dark:bg-slate-600 dark:text-black">
      ...
      {/* if there is a button in form, it will close the modal */}
        ...
        <div className="mt-4 space-y-2">
            <span>fullname</span>
            <br />
            <input type="text" {...register("fullname", { required: true })} placeholder='Enter your Name' className="w-80 px-3 py-1 border rounded-md outline-none" />
            <br />
        ...
        <div className="mt-11 space-y-2">
            <span>Password</span>
            <br />
            <input type="Password" {...register("password", { required: true })} placeholder='Enter your Password' className="w-80 px-3 py-1 border rounded-md outline-none" />
            <br />
